      ...
      <div className="grid md:grid-cols-3 gap-6 mt-6 not-prose pl-3 ">
        {infoData.map((info) => (
          <Link
            ...
            href={info.link}
          >
            <div className="w-full flex flex-col items-center justify-center pt-4 dark:bg-black dark:text-white">
            <h3 className=" pr-3 text-lg font-semibold text-gray-800  dark:text-white group-hover:text-[#198754] transition-colors duration-300">
                {info.title}
              </h3>
              </div>
            <div className="w-full flex flex-col items-center justify-center p-1 dark:bg-black">
            ...
            />
              ...
              <p className="text-sm text-gray-600 pr-3  dark:text-white">{info.description}</p>
              <Link href={info.link}>
