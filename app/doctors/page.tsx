            ...
            >
              ...
              >
                ...
                <div className="p-4  dark:bg-black">
                  {/* Name and Title */}
                  <span className="block text-lg font-semibold dark:text-white text-gray-800 group-hover:text-[#198754] transition-colors duration-300">
                    {doctor.name}
                  </span>
                  <span className="block text-md !text-[#198754] mb-2 dark:text-white">
