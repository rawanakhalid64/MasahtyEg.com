...
const Page = async () => {
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full">
              ...
              <div className="w-full md:w-1/2">
                <h5 className="leading-relaxed">
                  ...
                  &nbsp; هي المؤسسة الرائدة في مجال علاج الإدمان والطب النفسي،
                  ولها تاريخ يمتد لأكثر من سبع سنوات من النجاح والتفوق. خلال هذه
                  الفترة، ساهمت في شفاء العديد من الأفراد من الإدمان، وأثبتت
                  مكانتها كأفضل وجهة في هذا المجال. تقدم
                  <Link href="/" className="font-bold !no-underline">
                    {" "}
                    مصحتي{" "}
                  </Link>
                  ...
                  <Link
                    ...
                    className="!text-[#198754] !no-underline mr-2"
                  >
          ...
          <div className="flex flex-col items-center justify-center mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
              ...
              <div className="pt-3 px-9 font-medium text-[#627577] border rounded-lg transition-transform duration-300 hover:scale-105 shadow-md hover:shadow-lg">
                <h3 className="flex items-center justify-center !text-3xl !font-bold  text-[#198754] mb-4">
                  رؤيتنا
                </h3>
                <p className="mb-3">
              ...
              {/* Block for "أهدافنا" */}
              <div className="pt-3  px-9 font-medium text-[#627577] border rounded-lg transition-transform duration-300 hover:scale-105 shadow-md hover:shadow-lg">
                <h3 className=" flex items-center justify-center !text-3xl !font-bold mb-4 text-[#198754]">
                  أهدافنا
                </h3>
                <ul className="">
                  <li>
            ...
            <div className="pt-3  flex items-center justify-center flex-col font-medium text-[#627577] w-full mt-8">
              <h3 className=" !text-3xl !font-bold mb-4 text-[#198754]">
                لماذا تختار مصحتي؟
              </h3>
              <ul className="">
                <li>
  ...
  <LazyVideo
    videoSrc="/videos/masahety.mp4" // Corrected path to your local video
    posterSrc="/thubnail-image/Screenshot%202024-10-13%20162726.png
" // Corrected path to your poster image
    width="560" // Customize the width
    height="315" // Customize the height
    className="mx-auto" // Tailwind CSS styling (centered)
  />
</div>
        </div>
      </section>
